...
function problemA() {
    ...
    promisifiedReadFile('poem-one/stanza-01.txt').then(function successHandler1(result) {
...
function problemB() {
    ...
    // promise version
    // ???
    promisifiedReadFile('poem-one/stanza-02.txt').then(function successHandler1(result) {
        // use the value inside this callback
        console.log('stanza-02 is done!!!');
        blue(result); // woah, returning something async?
    });
...
function problemC() {
    ...
    promisifiedReadFile('poem-one/stanza-02.txt')
        .then(function successHandler1(stanza2) {
            // use the value inside this callback
            console.log('stanza-02 is done!!!');
            blue(stanza2); // woah, returning something async?
            return promisifiedReadFile('poem-one/stanza-03.txt')
        })
        .then(function successHandler1(stanza3) {
            // use the value inside this callback
            console.log('stanza-03 is done!!!');
            blue(stanza3); // woah, returning something async?
        });
